...
\rubric{In \Rnum{1} Nocturno, et in Feriis \Rnum{2} et \Rnum{5} in Officio feriali:}
...
\rubric{In \Rnum{2} Nocturno, et in Feriis \Rnum{3} et \Rnum{6} in Officio feriali:}
...
\rubric{In \Rnum{3} Nocturno, et in Feriis, quando legitur Homilia cum Evangelio:}
...
\rubric{Feria \Rnum{4} et Sabbato in Officio feriali:}
...
\rubric{In Festis Sanctorum trium lectionum:}
