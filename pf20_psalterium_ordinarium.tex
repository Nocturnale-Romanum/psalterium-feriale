...
\ifcsname preamble@file\endcsname
  \setcounter{page}{\getpagerefnumber{M-pf20_psalterium_ordinarium}}
\fi
...
\rubric{Antiphonæ, Psalmi et Versus Nocturnorum ut in Psalterio. Versus cantatur hoc modo, et item respondetur:}
...
\rubric{In \Rnum{1} Nocturno, et Feriæ \Rnum{2} et \Rnum{5} in diebus trium lectionum:}
...
\rubric{In \Rnum{2} Nocturno, et Feriæ \Rnum{3} et \Rnum{6} in diebus trium lectionum:}
...
\rubric{In \Rnum{3} Nocturno, et Feria \Rnum{4} et Sabbato in diebus trium lectionum:}
...
\titlerubric{In \Rnum{1} Nocturno, et in Feriis \Rnum{2} et \Rnum{5} in Officio feriali:}
...
\titlerubric{In \Rnum{2} Nocturno, et in Feriis \Rnum{3} et \Rnum{6} in Officio feriali:}
...
\titlerubric{In \Rnum{3} Nocturno, et in Feriis, quando legitur Homilia:}
...
\rubric{In Dominicis, Feriis et Festis Domini:}\\
...
\rubric{\emph{Benedictio 2.}}
Cujus \rubric{(vel} Quorum \rubric{aut} Quarum\rubric{)} \textit{festum} \textbf{có}limus,~\GreSpecial{*} 
ipse \rubric{(vel} ipsa \rubric{aut} ipsi \rubric{vel} ipsæ\rubric{)}
...
\hspace{\specialcharhsep}\rr Amen.\\
\rubric{sed si fit commemoratio Feriæ vel Dominicæ:}\\
\rubric{\emph{Benedictio 3.}}
Per evangé\textit{lica} \textbf{dic}ta~\GreSpecial{*}
deleántur nostra delícta.
\hspace{\specialcharhsep}\rr Amen.

\titlerubric{Feria \Rnum{4} et Sabbato in Officio feriali:}
...
\titlerubric{In Festis Sanctorum trium lectionum:}
...
\titlerubric{In Officio B.M.V. in Sabbato:}
...
\rubric{Post ultimam Lectionem, in Dominicis, in Festis, per Octavas, et in Feriis Tempore Paschali, dicitur Hymnus Ambrosianus, pag.\ \pageref{M-ORTDb}. In Adventu autem, et a Dominica Septuagesimæ usque ad Sabbatum sanctum inclusive, non dicitur nisi in Festis.}
...
\rubric{In diebus novem lectionum:}
...
\end{multicols}
\versiculus{Beáta víscera Maríæ Vírginis, quæ portavérunt ætérni Pátris Fílium.}{Et beáta úbera, quæ lactavérunt Christum Dóminum.}
...
\rubric{Pneumata in fine ultimæ cujuscumque Nocturni Antiphonæ, in Dominicis et Festis, ubi mos est, adjungi possunt.}
