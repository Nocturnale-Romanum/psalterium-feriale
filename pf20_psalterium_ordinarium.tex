...
\rubric{In \Rnum{1} Nocturno dierum novem lectionum, et Feriæ \Rnum{2} et \Rnum{5} in diebus trium lectionum:}
...
\rubric{In \Rnum{2} Nocturno dierum novem lectionum, et Feriæ \Rnum{3} et \Rnum{6} in diebus trium lectionum:}
...
\rubric{In \Rnum{3} Nocturno dierum novem lectionum, et Feria \Rnum{4} et Sabbato in diebus trium lectionum:}
...
\rubric{In \Rnum{1} Nocturno dierum novem lectionum, et in Feriis \Rnum{2} et \Rnum{5}:}
...
\rubric{In \Rnum{2} Nocturno dierum novem lectionum, et in Feriis \Rnum{3} et \Rnum{6}:}
...
\rubric{In \Rnum{3} Nocturno dierum novem lectionum, et in Feriis, quando legitur Homilia cum Evangelio:}
...
\rubric{In Dominicis et Festis Domini:}
...
\rubric{In Feriis, Feria \Rnum{4} et Sabbato:}
